...
using Section15.Assignment27.Services;
using Xunit.Abstractions;

namespace Section15.Assignment27.Tests;
...
public class StocksServiceTests
{
    ...
    public async Task GetBuyOrders_List()
    {
        ...
        {
            expectedBuyOrders.Add(await _stocksService.CreateBuyOrder(buyOrderRequest));
        }
        //print expected
        ...
        //Act
        var actualbuyOrders = await _stocksService.GetBuyOrders();
        //print actual
    ...
    public async Task GetSellOrders_List()
    {
        ...
        {
            expectedSellOrders.Add(await _stocksService.CreateSellOrder(sellOrderRequest));
        }
        //print expected
        _testOutputHelper.WriteLine("Expected");
        ...
        //Act
        var actualSellOrders = await _stocksService.GetSellOrders();
        //print actual
        _testOutputHelper.WriteLine("Actual");
