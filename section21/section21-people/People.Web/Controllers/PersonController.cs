...
public class PersonController(IPersonsService personsService, ICountriesService countriesService) : Controller
{
    ...
    [Route("/persons/index")]
    [HttpGet]
    [TypeFilter(typeof(PersonsListActionFilter), Arguments = [1, "index"])]
    [PersonListResultFilter(0, "mykey", "myval", false)]
    [CreateFilterFactory(-2, "CreateFilterFactory for person index")]
    ...
    [HttpGet]
    //[TypeFilter(typeof(BypassAuthFilter))]
    //[TypeFilter(typeof(BypassResourceFilter))]
    //[TypeFilter(typeof(BypassActionFilter))]
    //[TypeFilter(typeof(BypassResultFilter))]
    [TypeFilter(typeof(BypassAsyncResultFilter))]
    [TypeFilter(typeof(HitResourceFilter))]
    [TypeFilter(typeof(HitActionFilter))]
    [TypeFilter(typeof(HitResultFilter), Order = 100)]
